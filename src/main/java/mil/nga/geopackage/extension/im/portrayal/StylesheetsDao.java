...
public class StylesheetsDao extends GeoPackageDao<Stylesheets, Long> {
	 ...
	 * @return dao
	 */
	public static StylesheetsDao create(GeoPackageCore geoPackage) {
	 ...
	 * @return dao
	 */
	public static StylesheetsDao create(GeoPackageCoreConnection db) {
		return GeoPackageDao.createDao(db, Stylesheets.class);
	}
